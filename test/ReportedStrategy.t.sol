...
contract ReportedStrategyTest is BaseFountfiTest {
    ...
    function testFuzz_Decimals_Calculations(
        uint8 assetDecimals,
        ...
        assertApproxEqRel(balanceAtParPrice, depositAmount, 0.001e18, "Balance at 1:1 price should approximately equal deposit");
    }
}
