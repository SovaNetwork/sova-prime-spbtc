...
contract ShareCalculationFuzzTest is BaseFountfiTest {
     ...
     */
    function testFuzz_ShareCalculationAcrossScales(
        uint8 scale,
        ...
        console2.log("Alice deposited:", deposits[0]); console2.log("Alice shares:", aliceShares);
        ...
        console2.log("Bob deposited:", deposits[1]); console2.log("Bob shares:", bobShares);
        ...
        console2.log("Charlie deposited:", deposits[2]); console2.log("Charlie shares:", charlieShares);
        console2.log("Share price after Charlie:", sharePrices[3]);
        
        // Verify proportional ownership
        _verifyProportionalOwnership(
            [alice, bob, charlie],
            [aliceShares, bobShares, charlieShares],
            [deposits[0], deposits[1], deposits[2]]
        );
    }
    ...
    function testFuzz_ExtremeRatios(
        ...
        uint256[5] memory subsequentDeposits
    ) public {
        ...
        for (uint256 i = 0; i < 5; i++) {
            ...
            console2.log("Small deposit:", smallDeposit); console2.log("Expected vs actual shares:", expectedShares);
     ...
     */
    function testFuzz_DepositWithdrawCycles(
        uint256[5] memory deposits,
        uint256[5] memory withdrawFractions
    ) public {
        ...
        for (uint256 cycle = 0; cycle < 5; cycle++) {
            ...
            for (uint256 i = 0; i < 3; i++) {
                ...
                operations.push(DepositWithdrawPair({
                    user: user,
     ...
     */
    function testFuzz_ShareValueMonotonicity(
        uint8 numOperations,
    ...
    function _verifyProportionalOwnership(
        ...
        for (uint256 i = 0; i < 3; i++) {
            if (shares[i] > 0) {
                ...
                assertApproxEqRel(
                    ...
                    expectedProportion,
                    MAX_RELATIVE_ERROR,
                    "Proportional ownership violated"
                );
            }
        }
    }
